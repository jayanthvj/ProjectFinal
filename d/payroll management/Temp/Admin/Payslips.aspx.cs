...
public partial class Admin_Payslips : System.Web.UI.Page
{
    ...
    {
        string qry = "insert into payslip values('" + TextBox1.Text + "','" + TextBox12.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + DateTime.Now.ToString() + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + TextBox9.Text + "','" + TextBox10.Text + "','" + TextBox11.Text + "')";
